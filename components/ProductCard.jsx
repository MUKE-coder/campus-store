...
export default function Product({ product , addToCart }) {
  ...
  return (
    <div
      className="relative flex flex-col gap-1 rounded-sm w-[100%] lg:w-[100%] transform transition-transform hover:scale-95 h-[100%]"
      onClick={handleClick}
    >
      <Link
      ...
      <div className="flex-col flex gap-1 px-2 pb-3 lg:pb-1 lg:px-4 h-[40%] mt-2 lg:mt-4">
