      ...
      {isLoading ? (
        ...
        <>
          <div className="px-4 md:px-8 md:py-8 py-4">
            ...
            <p>{cat.description}</p>
            <div className="flex gap-2 md:gap-4 mb-4 md:mb-8 mt-4 flex-wrap items-center">
          ...
          <div className="grid gap-6 lg:gap-8 w-full grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4">
