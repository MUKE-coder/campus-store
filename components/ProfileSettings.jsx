...
export function ProfileForm({ id, singleProfile }) {
  const [loading, setLoading] = useState(false)
  const [imageUrls, setImageUrls] = useState(singleProfile?.image ? [singleProfile.image] : []);
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                This is your public display Address. It can be your real address or a pseudonym.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
