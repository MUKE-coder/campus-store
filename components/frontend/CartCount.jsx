...
export default function CartCount({backgroundColor}) {
  ...
  return (
    ...
    >
      ...
      ">Cart</span>
      <div style={{backgroundColor}} className="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white  rounded-full top-0 left-0 end-6 dark:border-gray-900">
        {cartItems.length}
      </div>
    </Link>
  );
