...
export default function MobileCart({backgroundColor}) {
  ...
  return (
    ...
    >
      ...
      ">Cart</span>
      <div  className="inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white absolute left-0 top-1  rounded-full  dark:border-gray-900 bg-red-300">
